...
class Dataset_Training(Dataset):
    ...
    Args:
        root_dir: Path to dataset files.
        crop_shape: Cuboid shape the images will be reduced to. Set to (240,240,155) to lose no data.
        center_on_mask: Center cropped cuboid at the mask. #TODO: nicht übernommen

    Raises:
        UserWarning: If your dataset does not contain files having the proper shape (240,240,155) #TODO: nicht übernommen
    ...
    Returns:
        __getitem__: Returns a dictionary containing:
            ...
            "cropped_bbox": Bounding box that was used for cropping #TODO: nicht übernommen
            "max_v": Maximal value of t1 image (used for normalization)
            "name": Sample ID. e.g. "BraTS-GLI-00003-000" #TODO: nicht übernommen
    """
    ...
    def preprocess(self, t1n: np.ndarray, healthy_mask: np.ndarray):
        ...
        Returns:
            t1n_voided_healthy_crop: Cropped version of voided t1n based on healthy tissue.  #TODO: nicht übernommen
            t1n_max_v: Maximal value of t1n image (used for normalization).
            crop_box: Bounding box that was used for cropping.  #TODO: nicht übernommen
            t1n_crop: The cropped version of t1n.
            healthy_mask_crop: Cropped version of the healthy mask.  #TODO: nicht übernommen
        ...
        # Crop to smaller size
        if self.center_on_mask:  # crop to region aground target #TODO: nicht übernommen, weil sie machen dies um Dimensionality zu reduzieren.
        ...
        # crop if bigger #TODO: nicht übernommen
        t1n_crop, healthy_mask_crop = random_crop(self.crop_shape, t1n_crop, healthy_mask_crop)

        # void ground truth where healthy #TODO: nicht übernommen
        ...
        # add dimension for channel (we only have one though)  #TODO: nicht übernommen
        ...
        # set fitting datatype  #TODO: nicht übernommen
    ...
    def __getitem__(self, idx):
        ...
        sample_dict = {
            ...
            "name": healthy_mask_path.name[:19], #TODO: nicht übernommen
        }

        return sample_dict

    @classmethod
    def get_result_image(cls, prediction, sample): #TODO: nicht übernommen, weil ich habe keine prediction für ein spezifisches sample. Ich habe einfach ein neues synthetisches sample. Einzige Todos wären crop zu (256,256,160) und save as nifti.
        """Reverse the transformations that were necessary for the network.
