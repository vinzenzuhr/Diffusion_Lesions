...
def evaluate(config, epoch, pipeline, eval_dataloader, global_step):
...
def train_loop(config, model, noise_scheduler, optimizer, lr_scheduler):
    ...
    evaluate(config, epoch, pipeline, eval_dataloader, global_step)
...
get_ipython().system('jupyter nbconvert --to script "lesion_filling_conditioned_lesions.ipynb"')
filename="lesion_filling_conditioned_lesions.ipynb"
