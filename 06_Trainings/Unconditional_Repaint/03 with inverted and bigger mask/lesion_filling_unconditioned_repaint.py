...
class TrainingConfig:
    ...
    output_dir = "lesion-filling-256_2"  # the model name locally and on the HF Hub
...
voided_img=img*mask
plt.imshow((voided_img+1)/2)
plt.savefig('voided_img.png')


# In[14]:


inpainted_img = rePaint(voided_img.unsqueeze(0).unsqueeze(0), mask, generator=gen, output_type="np.array")
